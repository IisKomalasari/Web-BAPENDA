...
<head>
    ...
    <title>Halaman Edit Sejarah | Badan Pendapatan Daerah Kabupaten Garut</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Sejarah</h1>
                </div>
                <!-- /.container-fluid -->
              ...
              <div class="card mt-3">
                <div class="card-header">
                  ...
                  <?php
                    ...
                    //query
                    $query = "SELECT * FROM sejarah WHERE id_sejarah='$id_sejarah'";
                    $result = mysqli_query($koneksi, $query);

                    ?>
                </div>
                <div class="card-body">
                <form role="form" action="editsejarah.php" method="get">
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_sejarah" value="<?php echo $row['id_sejarah']; ?>">

                        <div class="mb-3">
                          <label for="judul_sejarah" class="form-label">Judul Sejarah</label>
                          <input type="text" class="form-control" name="judul_sejarah" id="judul_sejarah" value="<?= $row['judul_sejarah']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="isi_sejarah" class="form-label">Isi Sejarah</label>
                          <input type="text" class="form-control" name="isi_sejarah" id="isi_sejarah" value="<?= $row['isi_sejarah']; ?>">
                        </div>
                        <button type="submit" class="btn btn-primary mt-3">Update Sejarah</button>
                        <?php
                        }
