...
<head>
    ...
    <title>Video Bapenda | Badan Pendapatan Daerah Garut</title>
</head>
            ...
            <div class="tema3">
              ...
              <div >
                <?php
                        ...
                        ?>
                            <tr align="center">
                            <p class="judul-video" style="color:black">
                                <td><?php echo $no++; ?>
                                <td>.<?php echo $row['deskripsi_video']; ?></td>
                             </p>
                                <video src="images/<?php echo $row['file_video']; ?>" width="350px" height="200px" controls></video>
