...
<head>
    ...
    <title>Halaman Tambah Struktur Organisasi | Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah Struktur Organisasi</h1>
        <?php
        //koneksi database
        include('koneksi.php');
        ?>
    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form role="form" action="insert_strukturorganisasi.php" method="post">    
                    <div class="form-group mt-3">
                        <label for="nm_strukturorganisasi">Nama Struktur Organisasi</label>
                        <input type="text" name="nm_strukturorganisasi" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="deskripsi_strukturorganisasi">Deskripsi Struktur Organisasi</label>
                        <input type="text" name="deskripsi_strukturorganisasi" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="image_strukturorganisasi"> Pilih Gambar</label>
                        <br>
                        <input type="file" name="image_strukturorganisasi" accept="images/png, images/jpg, images/jpeg" id="image_strukturorganisasi">
                    </div>
                    <button type="submit" name="tambah" class="btn btn-primary mt-3">Tambah Struktur Organisasi</button>
                </form>
            </div>
            </div>
        </div>
        ...
        if(isset($_POST['tambah'])){
            ...
            $image_strukturorganisasi = $_FILES['image_strukturorganisasi']['name'];
            $source = $_FILES['image_strukturorganisasi']['tmp_name'];
            $folder = './images/';
            move_uploaded_file( $source, $folder.$image_strukturorganisasi);
        }
        ?>  
