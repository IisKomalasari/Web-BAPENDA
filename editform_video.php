...
<head>
    ...
    <title>Halaman Edit Foto| Badan Pendapatan Daerah Kabupaten Garut</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Video</h1>
                </div>
                <!-- /.container-fluid -->
            ...
            <div class="container">
              <div class="card mt-3">
                ...
                <div class="card-body">
                <form role="form" action="edit_video.php" method="get" enctype="multipart/form-data">
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_video" value="<?php echo $row['id_video']; ?>">
                        ...
                        <div class="mb-3">
                          <label for="nm_video" class="form-label">Nama Video</label>
                          <input type="text" class="form-control" name="nm_video" id="nm_video" value="<?= $row['nm_video']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="deskripsi_video" class="form-label"> Deskripsi Video</label>
                          <input type="text" class="form-control" name="deskripsi_video" id="deskripsi_video" value="<?= $row['deskripsi_video']; ?>">
                        </div>
                        ...
                        <button type="submit" name="submit" class="btn btn-primary mt-3">Update Video</button>
                        <?php
                        }
