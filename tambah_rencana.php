...
<head>
    ...
    <title>Halaman Tambah Rencana Kerja  | Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah Rencana Kerja</h1>
        <?php
        //koneksi database
        include('koneksi.php');
        ?>
    ...
    <div class="container">
        <div class="card mt-3">
            <div class="card-header">
                <h3>Form Rencana Kerja</h3>
            </div>
            <div class="card-body">
                <form role="form" action="insert_rencana.php" method="POST">    
                    <div class="form-group mt-3">
                        <label for="nm_rencana">Nama Rencana Kerja</label>
                        <input type="text" name="nm_rencana" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="file_rencana"> Pilih File</label>
                        <br>
                        <input type="file" id="file_rencana" name="file_rencana" accept="application/pdf">
                    </div>
                    <button type="submit" name="tambah" class="btn btn-primary mt-3">Tambah File Rencana Kerja</button>
                </form>
            </div>
            </div>
        </div>
        ...
        if(isset($_POST['tambah'])){
            ...
            $file_rencana = $_FILES['file_rencana']['name'];
            $source = $_FILES['file_rencana']['tmp_name'];
            $folder = './dokumen/';

            move_uploaded_file( $source, $folder.$file_rencana);
        }
        ?>    
