...
<head>
    ...
    <title>Halaman Struktur Organisasi | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Struktur Organiasi BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body" >
                        <a href="tambah_strukturorganisasi.php" class="btn btn-primary">Tambah Struktur Organisasi</a>
                    </div>
                    <div class="card-body">
                         ...
                         <table class="table table-bordered table-striped">
                            ...
                            <tr class="text-center">
                                ...
                                <th>Deskripsi Struktur Organisasi</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['nm_strukturorganisasi']; ?></td>
                                    <td><?php echo $row['deskripsi_strukturorganisasi']; ?></td>
                                    <td><img src="images/<?php echo $row['image_strukturorganisasi']; ?>" width="100px" height="100px"></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_strukturorganisasi.php?id_strukturorganisasi=<?php echo $row['id_strukturorganisasi']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_strukturorganisasi.php?id_strukturorganisasi=<?php echo $row['id_strukturorganisasi']; ?>" onclick="return confirm('Anda yakin ingin hapus')"  class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
