...
<head>
    ...
    <title>Foto Bapenda | Badan Pendapatan Daerah Garut</title>
</head>
...
<?php
  ...
  <div class="navbar"> 
    ...
    <section id="gallery">
      <div class="container">
        <h1 class="tema">Foto Kegiatan</h1>
        ...
        <?php
               $no = 1;
                ...
                ?>
                    <tr align="center">
                       <td width="500px" height="100px"><img src="images/<?php echo $row['file_foto']; ?>"></td>
                           <td width="500px" height="100px"><img src="images/<?php echo $row['file_foto2']; ?>"></td>
                            <td width="500px" height="100px"><img src="images/<?php echo $row['file_foto3']; ?>"></td>
                               <td><?php echo $row['tanggal']; ?></td><br>
