...
<head>
    ...
    <title>Halaman Tambah SOP Perpajakan  | Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah SOP Perpajakan</h1>
        <?php
        //koneksi database
        include('koneksi.php');
        ?>
    ...
    <div class="container">
        <div class="card mt-3">
            <div class="card-header">
                <h3>Form SOP Perpajakan</h3>
            </div>
            <div class="card-body">
                <form role="form" action="insert_sop.php" method="post" >    
                    <div class="form-group mt-3">
                        <label for="nm_sop">Nama SOP Perpajakan</label>
                        <input type="text" name="nm_sop" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="file_sop"> Pilih File</label>
                        <br>
                        <input type="file" id="file_sop" name="file_sop">
                    </div>
        ...
        if(isset($_POST['tambah'])){
            $nm_sop = $_POST['nm_sop'];
            $file_sop = $_FILES['file_sop']['name'];
            $source = $_FILES['file_sop']['tmp_name'];
            $folder = './dokumen/';
            // validasi format file
            $tipe_diizinkan = array('pdf','xlsx','pptx','docx');
            if(!in_array($tipe_diizinkan)){
