...
<head>
    ...
    <title>Halaman Visi & Misi | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Visi Misi BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body">
                        <a href="tambah_visimisi.php" class="btn btn-primary">Tambah Visi Misi</a>
                    </div>
                    <div class="card-body">
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        <a href="editform_visimisi.php?id_visimisi=<?php echo $row['id_visimisi']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_visimisi.php?id_visimisi=<?php echo $row['id_visimisi']; ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
