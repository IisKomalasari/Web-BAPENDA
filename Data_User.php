...
<head>
    ...
    <title>Halaman Pengelolaan Data Admin| Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center " >
                        <h3>Halaman Pengelolaan Data Pengguna</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body">
                        <a href="form_tambah.php" class="btn btn-primary">Tambah Pengguna</a>
                    </div>
                    <div class="card-body">
                        <form method="post" action="editform_user.php">
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                            <a href="editform_user.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                            <a href="delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
