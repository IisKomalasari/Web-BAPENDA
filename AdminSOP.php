...
<head>
    ...
    <title>Halaman Admin SOP Perpajakan | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan SOP Perpajakan BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');

                        //query
                        $query = "SELECT * FROM sop_perpajakan";
                    ...
                    <div class="card-body" >
                        <a href="tambah_sop.php" class="btn btn-primary">Tambah SOP Perpajakan</a>
                    </div>
                    <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data"> 
                         <table class="table table-bordered table-striped">
                            ...
                            <tr class="text-center">
                                <th>No.</th>
                                <th>Nama SOP Perpajakan</th>
                                <th>File SOP Perpajakan</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['nm_sop']; ?></td>
                                    <td><?php echo $row['file_sop']; ?></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_sop.php?id_sop=<?php echo $row['id_sop']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_sop.php?id_sop=<?php echo $row['id_sop'];?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm " role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
