        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Foto</h1>
                </div>
                <!-- /.container-fluid -->
            ...
            <div class="container">
              <div class="card mt-3">
                ...
                <div class="card-body">
                <form role="form" action="edit_foto.php" method="get" >
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_foto" value="<?php echo $row['id_foto']; ?>">
                        ...
                        <div class="mb-3">
                          <label for="nm_foto " class="form-label">Nama Foto</label>
                          <input type="text" class="form-control" name="nm_foto" id="nm_foto" value="<?= $row['nm_foto']; ?>">
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="deskripsi_foto" id="deskripsi_foto" value="<?= $row['deskripsi_foto']; ?>">
                        </div>
                            <div class="form-group mt-3">
                        ...
                        <br>
                            <input type="file" name="file_foto2" class="form-control">
                        </div>
                        <div class="form-group mt-3">
                            <label for="file_foto3"> Pilih Gambar</label>
                        <br>
                          <input type="file" name="file_foto3"  class="form-control">
                        </div>
