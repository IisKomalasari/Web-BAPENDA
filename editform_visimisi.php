...
<head>
    ...
    <title>Halaman Edit Visi Misi | Badan Pendapatan Daerah Kabupaten Garut</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Visi Misi</h1>
                </div>
                <!-- /.container-fluid -->
              ...
              <div class="card mt-3">
                <div class="card-header">
                  ...
                  <?php
                    ...
                    //query
                    $query = "SELECT * FROM visi_misi WHERE id_visimisi='$id_visimisi'";
                    $result = mysqli_query($koneksi, $query);

                    ?>
                </div>
                <div class="card-body">
                <form role="form" action="editvisimisi.php" method="get">
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_visimisi" value="<?php echo $row['id_visimisi']; ?>">
                        ...
                        <div class="mb-3">
                          <label for="isi_visi" class="form-label">Visi</label>
                          <input type="text" class="form-control" name="isi_visi" id="isi_visi" value="<?= $row['isi_visi']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="isi_misi" class="form-label">Misi</label>
                          <input type="text" class="form-control" name="isi_misi" id="isi_misi" value="<?= $row['isi_misi']; ?>">
                        </div>
