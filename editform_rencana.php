        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Rencana Kerja</h1>
                </div>
                <!-- /.container-fluid -->
              ...
              <div class="card mt-3">
                <div class="card-header">
                  ...
                  <?php
                    ...
                    //query
                    $query = "SELECT * FROM rencana_kerja WHERE id_rencana='$id_rencana'";
                    $result = mysqli_query($koneksi, $query);

                    ?>
                </div>
                <div class="card-body">
                <form role="form" action="edit_rencana.php" method="get" enctype="multipart/form-data">
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_rencana" value="<?php echo $row['id_rencana']; ?>">
                        ...
                        <div class="mb-3">
                          <label for="nm_rencana" class="form-label">Nama File</label>
                          <input type="text" class="form-control" name="nm_rencana" id="nm_rencana" value="<?= $row['nm_rencana']; ?>">
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary mt-3">Update Rencana Kerja</button>
                        <?php
                        }
