...
<head>
    ...
    <title>Halaman Edit Berita | Badan Pendapatan Daerah Kabupaten Garut</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Berita</h1>
                    <?php
            ...
            <div class="container">
              <div class="card mt-3">
                ...
                <div class="card-body">
                <form role="form" action="edit_berita.php" method="get" enctype="multipart/form-data" >
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_berita" value="<?php echo $row['id_berita']; ?>">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="judul_berita" id="judul_berita" value="<?= $row['judul_berita']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="tgl_berita" class="form-label"> Tanggal Berita</label>
                          <input type="date" class="form-control" name="tgl_berita" id="tgl_berita" value="<?= $row['tgl_berita']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="deskripsi_berita" class="form-label"> Deskripsi Berita</label>
                          <input type="text" class="form-control" name="deskripsi_berita" id="deskripsi_berita" value="<?= $row['deskripsi_berita']; ?>">
                        </div>
                        <div class="form-group mt-3">
                        <label for="image_berita">Gambar Berita</label>
                        <br>
                        <input type="file" name="image_berita">
                        </div>
