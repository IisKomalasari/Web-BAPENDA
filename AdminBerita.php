...
<head>
    ...
    <title>Halaman Berita | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Berita BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $row['deskripsi_berita']; ?></td>
                                    <td><img src="images/<?php echo $row['image_berita']; ?>" width="100px" height="100px"> </td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_berita.php?id_berita=<?php echo $row['id_berita']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_berita.php?id_berita=<?php echo $row['id_berita'];?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
