        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Data Pengguna</h1>
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="nama_petugas" id="nama_petugas" value="<?= $row['nama_petugas']; ?>">
                        </div>
                        <div class="mb-3">
