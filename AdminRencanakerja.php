...
<head>
    ...
    <title>Halaman Rencana Kerja | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Rencana Kerja BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body" >
                        <a href="tambah_rencana.php" class="btn btn-primary">Tambah Rencana Kerja</a>
                    </div>
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $row['file_rencana']; ?></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_rencana.php?id_rencana=<?php echo $row['id_rencana']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_rencana.php?id_rencana=<?php echo $row['id_rencana'] ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
