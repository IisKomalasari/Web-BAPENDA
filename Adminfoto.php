...
<head>
    ...
    <title>Halaman Foto | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Foto Kegiatan BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['nm_foto']; ?></td>
                                    <td><?php echo $row['tanggal']; ?></td>
                                    <td><?php echo $row['deskripsi_foto']; ?></td>
                                    <td><img src="images/<?php echo $row['file_foto']; ?>" width="100px" height="100px"></td>
                                    <td><img src="images/<?php echo $row['file_foto2']; ?>" width="100px" height="100px"></td>
                                    <td><img src="images/<?php echo $row['file_foto3']; ?>" width="100px" height="100px"></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_foto.php?id_foto=<?php echo $row['id_foto']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_foto.php?id_foto=<?php echo $row['id_foto']; ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
