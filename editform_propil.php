...
<main>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <div class="card mt-3">
                <h3 align="center">Edit Informasi Profil Pengguna</h3>
                    <div class="card-header text-left">
                    <div class="card-body">
                <form role="form" action="edit_propil.php" method="get">
                    <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                    <div class="form-group">
                        <label for="nama_petugas">Nama </label>
                        <input type="text" name="nama_petugas" class="form-control" value="<?php echo $row['nama_petugas'];?>">
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <img class="brand-image img-circle elevation-3" src="images/<?php echo $row['gambar'];?>" height="100" width="100">
