...
<head>
    ...
    <title>Halaman Sejarah| Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Sejarah BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['judul_sejarah']; ?></td>
                                    <td><?php echo $row['isi_sejarah']; ?></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_sejarah.php?id_sejarah=<?php echo $row['id_sejarah']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_sejarah.php?id_sejarah=<?php echo $row['id_sejarah'] ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
