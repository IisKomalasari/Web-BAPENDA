...
<head>
    ...
    <title>Halaman Tambah Video| Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah Video</h1>
    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form role="form" action="insert_video.php" method="POST">    
                    <div class="form-group mt-3">
                        <label for="nm_video"> Nama Video</label>
                        <input type="text" name="nm_video" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="deskripsi_video">Deskripsi Foto</label>
                        <input type="text" name="deskripsi_video" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="file_video">Pilih Video</label>
                        <br>
                        <input type="file" name="file_video" multiple accept="video/mp4, video/mp3, video/gif">
                    </div>
                    <button type="submit" name="tambah" class="btn btn-primary mt-3">Tambah Video</button>
                </form>
            </div>
            </div>
        </div>
        ...
        if(isset($_POST['tambah'])){
            ...
            $source = $_FILES['file_video']['tmp_name'];
            $folder = './video/';
            move_uploaded_file( $source, $folder.$file_video);
        }
        ?>   
