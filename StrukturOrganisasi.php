...
<head>
    ...
    <title>Struktur Organisasi Bapenda | Badan Pendapatan Daerah Garut</title>
</head>
...
<?php
  ...
  <div class="navbar"> 
      ...
      <section class="Struktur">
        <h1>BAGAN STRUKTUR ORGANISASI <br> PENDAPATAN DAERAH </h1>
        <p class="par"> Berikut Bagan Struktur Organisasi Pendapatan Daerah</p>
      </section>
...
<section id="struktur-org">
        <div class="box-struk">
          <h1 class="tema" data-aos="fade-up">STRUKTUR ORGANISASI BADAN PENDAPATAN DAERAH</h1>
          <?php
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <tr align="center">
                            <td><img src="images/<?php echo $row['image_strukturorganisasi']; ?>" width="1500px" height="800px"></td>
                        </tr>
                    <?php
                    }
