...
<head>
    ...
    <title>Halaman Edit Struktur Organisasi | Badan Pendapatan Daerah Kabupaten Garut</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Edit Struktur Organisasi</h1>
                </div>
                <!-- /.container-fluid -->
            ...
            <div class="container">
              <div class="card mt-3">
                <div class="card-header">
                  <h3>Form Edit Struktur Organisasi</h3>
                  <?php
                    ...
                    //query
                    $query = "SELECT * FROM struktur_organisasi WHERE id_strukturorganisasi='$id_strukturorganisasi'";
                    $result = mysqli_query($koneksi, $query);

                    ?>
                </div>
                <div class="card-body">
                <form role="form" action="editstrukturorganisasi.php" method="get" >
                    ...
                    ?>
                      ...
                      <input type="hidden" name="id_strukturorganisasi" value="<?php echo $row['id_strukturorganisasi']; ?>">

                        <div class="mb-3">
                          <label for="nm_strukturorganisasi" class="form-label">Nama Struktur Organisasi</label>
                          <input type="text" class="form-control" name="nm_strukturorganisasi" id="nm_strukturorganisasi" value="<?= $row['nm_strukturorganisasi']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="deskripsi_strukturorganisasi" class="form-label"> Deskripsi Struktur Organisasi</label>
                          <input type="text" class="form-control" name="deskripsi_strukturorganisasi" id="deskripsi_strukturorganisasi" value="<?= $row['deskripsi_strukturorganisasi']; ?>">
                        </div>
                        <div class="form-group mt-3">
                        <label for="image_strukturorganisasi">Gambar Struktur Organisasi</label>
                        <br>
                        <input type="file" name="image_strukturorganisasi" class="form-control" id="image_strukturorganisasi" value="<?= $row['image_strukturorganisasi']; ?>" >
                        </div>
                        <button type="submit" class="btn btn-primary mt-3">Update Struktur Organisasi</button>
                        <?php
                        }
