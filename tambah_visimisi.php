...
<head>
    ...
    <title>Halaman Tambah Visi Misi | Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah Visi Misi</h1>
        <div id="layoutSidenav_content">
    <div class="container">
        <div class="card mt-3">
            <div class="card-header">
                <h3>Form Visi Misi</h3>
            </div>
            <div class="card-body">
                <form role="form" action="insert_visimisi.php" method="post">    
                    <div class="form-group mt-3">
                        <label for="isi_visi">Visi</label>
                        <input type="isi_visi" name="isi_visi" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="isi_misi">Misi</label>
                        <input type="isi_misi" name="isi_misi" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-primary mt-3">Tambah Visi Misi</button>
                </form>
            </div>
            </div>
        </div>
