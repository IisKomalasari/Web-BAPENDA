...
<main>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <div class="card mt-3">
                <h3 align="center">Informasi Profil Pengguna</h3>
                    <div class="card-header text-left">
                    <div class="card-body">
                <form role="form" method="get">
                    <div class="form-group">
                        <label for="nama_petugas">Nama </label>
                        <input type="text"  readonly name="nama_petugas" class="form-control" value="<?php echo $row['nama_petugas'];?>">
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="password" readonly name="password" class="form-control" value="<?php echo $row['password'];?>" >
                    </div>
                    <div class="form-group mt-3">
                        <label for="gambar">Gambar</label><br>
                       <img class="brand-image img-circle elevation-3" readonly src="images/<?php echo $row['gambar'];?>" height="110" width="110">
                    </div>
                    <button type="button" class="btn btn-primary mt-3"> 
                        <a href="editform_propil.php" style="color:white"> Edit Profil</a></button>
                </form>
                <?php
                                }
                            }
