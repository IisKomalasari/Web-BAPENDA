...
<head>
    ...
    <title>Halaman Tambah Berita | Badan Pendapatan Daerah Kabupaten Garut</title>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <h1 class="h3 mb-4 text-gray-800 text-center"> Halaman Tambah Berita</h1>
        <?php
            //koneksi database
            include('koneksi.php');
            ?>
    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form role="form" action="insert_berita.php" method="post" enctype="multipart/form-data">    
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" name="deskripsi_berita" class="form-control">
                    </div>
                    <div class="form-group mt-3">
                        <label for="image_berita"> Pilih Gambar</label>
                        <br>
                        <input type="file" id="image_berita"  name="image_berita" accept="images/png, images/jpg, images/jpeg"> 
                    </div>
                    <button type="submit" name="tambah" class="btn btn-primary mt-3">Tambah Berita</button>
                </form>
            </div>
            </div>
        </div>
        ...
        if(isset($_POST['tambah'])){
            ...
            $tgl_berita  = $_DATE['tgl_berita'];
            $deskripsi_berita = $_POST['deskripsi_berita'];
            $image_berita = $_FILES['image_berita']['name'];
            $source = $_FILES['image_berita']['tmp_name'];
            $folder = './images/';
    
            move_uploaded_file( $source, $folder.$image_berita);
        }
        ?>    
    </div>
    <!-- End of Page Wrapper -->
