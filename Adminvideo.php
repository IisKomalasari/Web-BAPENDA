...
<head>
    ...
    <title>Halaman Video | Badan Pendapatan Daerah Kabupaten Garut</title>
            ...
            <div class="container">
                <div class="card mt-3">
                    <div class="card-header text-center">
                        <h3>Halaman Pengelolaan Video Kegiatan BAPENDA GARUT</h3>
                        <?php
                        //tambahkan dbconnect
                        include('koneksi.php');
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['nm_video']; ?></td>
                                    <td><?php echo $row['deskripsi_video']; ?></td>
                                    <td><video src="images/<?php echo $row['file_video']; ?>" width="100px" height="100px"></video></td>
                                    <td>
                                        <p class="d-grid gap-2 col-15 mx-auto">
                                        <a href="editform_video.php?id_video=<?php echo $row['id_video']; ?>" class="btn btn-primary btn-sm" role="button">Edit</a>
                                        <a href="delete_video.php?id_video=<?php echo $row['id_video']; ?>" onclick="return confirm('Anda yakin ingin hapus')" class="btn btn-danger btn-sm" role="button">Delete</a>
                                        </p>
                                    </td>
                                </tr>
                            <?php
